...
<!--<script language="JavaScript" type="text/javascript"> alert("El Envío se ha iniciado, por favor no cierres esta ventana hasta que salga el resumen al final de la pagina.");   </script>-->
...
//#######   DECLARACIÓN DE VARIABLES NECESARIAS   #########//
	...
	$svr_smtp = $_POST["svr_smtp"];
	$usr_smtp = $_POST["usr_smtp"];
	$pss_smtp = $_POST["pss_smtp"];
...
//	$base =$_POST["base"]; //se lee el nombre de la base
	...
	//   if (feof($file)) break;
	//usleep(500000); // Esto puede agregar una pausa entre cada email, 1 millon = 1 segundo
...
//Server settings
    ...
    $smail->SMTPDebug = 5;                      // Enable verbose debug output
...
<script language="JavaScript" type="text/javascript"> alert("El Envío ha finalizado con éxito!"); </script>
</div>
